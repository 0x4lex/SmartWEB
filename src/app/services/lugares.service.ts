...
export class LugaresService {
  API_ENDPOINT = 'https://smartchain-47022.firebaseio.com/';
  lugares: any = [];
  ...
  public obtenerGeoData(direccion) {
    return this.http.get<any>(
      'https://maps.google.com/maps/api/geocode/json?address=' + direccion + '&key=AIzaSyCQBRbz2tHGpL1KeaAqZVoUcqdL-8BooKw'
    );
  }
}
